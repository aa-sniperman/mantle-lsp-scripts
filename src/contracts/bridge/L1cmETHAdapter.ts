...
export declare namespace L1cmETHAdapter {
  export type InitStruct = { delegate: AddressLike; owner: AddressLike };

  export type InitStructOutput = [delegate: string, owner: string] & {
    delegate: string;
    owner: string;
  };
}

export interface L1cmETHAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "SEND"
      | "SEND_AND_CALL"
  ...
  encodeFunctionData(
    ...
    values: [L1cmETHAdapter.InitStruct]
  ): string;
  encodeFunctionData(
...
export namespace ProtocolConfigChangedEvent {
  export type InputTuple = [
    setterSelector: BytesLike,
...
export interface L1cmETHAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): L1cmETHAdapter;
  waitForDeployment(): Promise<this>;

  interface: L1cmETHAdapterInterface;
  ...
  composeMsgSender: TypedContractMethod<[], [string], "view">;
  ...
  initialize: TypedContractMethod<
    [init: L1cmETHAdapter.InitStruct],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "composeMsgSender"
  ...
  >;
  getEvent(
    key: "ProtocolConfigChanged"
  ): TypedContractEvent<
    ProtocolConfigChangedEvent.InputTuple,
    ProtocolConfigChangedEvent.OutputTuple,
    ProtocolConfigChangedEvent.OutputObject
  >;
  ...
  filters: {
    ...
    "ProtocolConfigChanged(bytes4,string,bytes)": TypedContractEvent<
      ProtocolConfigChangedEvent.InputTuple,
      ProtocolConfigChangedEvent.OutputTuple,
      ProtocolConfigChangedEvent.OutputObject
    >;
    ProtocolConfigChanged: TypedContractEvent<
      ProtocolConfigChangedEvent.InputTuple,
      ProtocolConfigChangedEvent.OutputTuple,
      ProtocolConfigChangedEvent.OutputObject
    >;
